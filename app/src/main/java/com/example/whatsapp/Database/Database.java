...
import com.example.whatsapp.StudentData;
...
public class Database extends SQLiteOpenHelper {
    ...
    public void Update(int id,String name,String surname,String std){
        ...
        if (is == -1 ) {
            ...
            Toast.makeText(context, "Dta is Update", Toast.LENGTH_SHORT).show();
        }
